    ...
    "HmIP-WRC6": [
        {
            meta: {
                ...
                userExample: true,
                allowGallery: true,
                savedName: "Shutters & Lights",
                description: "Community example by Manfred for shutter and light controls.",
                savedId: null,
    ...
    shelly_blu_wall_4_button: [
        {
            meta: {
                ...
                userExample: true,
                allowGallery: true,
                savedName: "Shutters & Windows",
                description: "Community example by Manfred for shutters and windows.",
