...
const BASE_REMOTES: RemoteDefinition[] = [
    ...
    {
        id: "HM-PB-6-WM55",
        name: "HomeMatic Funk-Wandtaster 6fach",
        productIds: ["HM-PB-6-WM55"],
        tags: ["homematic", "ip"],
        widthMm: 55,
        heightMm: 55,
        cornerMm: 2,
    ...
    {
        id: "HmIP-WRC6",
        name: "HomeMatic IP Funk-Wandtaster 6fach",
        isDraft: true,
        isCommunity: true,
        productIds: ["HmIPW-WRC6", "HmIPW-WRC6-A", "HmIPW-WRC6-230", "HmIPW-WRC6-230-A"],
        description: "",
        notes: "",
        tags: ["homematic", "ip"],
        links: [
            { label: "Manufacturer", url: "https://de.elv.com/p/homematic-ip-smart-home-wandtaster-6-fach-hmip-wrc6-230-P162015/" },
            { label: "Image", url: "https://media.elv.com/pdsquare/162015_bild_01.jpg" },
            { label: "Print Template", url: "https://media.elv.com/file/154288_beschriftungsvorlage.pdf" },
        ],
        widthMm: 55,
        heightMm: 55,
        cornerMm: 2,
